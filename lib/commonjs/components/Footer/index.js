...
const StoryFooter = ({ stories, active, activeStory }) => {
    ...
    const footer = (0, react_1.useMemo)(() => stories[storyIndex]?.renderFooter?.(), [storyIndex]);
    return footer ? <react_native_1.View style={Footer_styles_1.default.container} pointerEvents="box-none">{footer}</react_native_1.View> : null;
};
exports.default = (0, react_1.memo)(StoryFooter);
